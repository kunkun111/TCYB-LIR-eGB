...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 24 11:02:19 2020
...
def exp_realworld(path, dataset_name, num_run, exp_function, **exp_parm):
    ...
    #np.savetxt(str(dataset_name)+'_naive_base200incre25.out', result , delimiter=',')
...
if __name__ == '__main__':
    ...
    # datasets = ['usenet1','usenet2']#batch40
    
    # datasets = ['weather']
    
    datasets = ['spam_corpus_x2_feature_selected','elecNorm']
    
    # datasets = ['airline']#batch100
