...
# -*- coding: utf-8 -*-
"""
Created on Wed Nov 25 21:00:13 2020
...
def evaluation_Kappa_GBDT(data, ini_train_size, win_size, max_tree, num_ince_tree, **GBDT_pram):
...
def exp_realworld(path, dataset_name, num_run, exp_function, **exp_parm):
    ...
    for r_seed in range(0, num_run):
        ...
        # np.savetxt(str(dataset_name)+ str(r_seed) +'_kappa_base200incre25.out', result , delimiter=',')
...
if __name__ == '__main__':
    ...
    for i in range (len(data_name)):
        ...
        exp_synthetic(path, dataset_name, num_run, num_eval, evaluation_Kappa_GBDT,
                      **IE_single_parm)
    ...
    for j in range (len(datasets)):
        ...
        exp_realworld(path_rel, dataset_name, num_run, evaluation_Kappa_GBDT,
                  **IE_single_parm)
